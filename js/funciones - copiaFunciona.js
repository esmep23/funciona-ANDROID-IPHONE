      ...
      success: function(response){  
        ...
        if(response!=null && response!='' && response!='[]'){ 
          $.each(response,function(key,value){ 
            ...
            imagen = value.imagen;
            //alert(id);
            document.getElementById('thumb').innerHTML  += '<div class="categorias"><a href="#all-Recetas" data-transition="fade" onclick="listCategory('+id+')"><img src='+url+imagen+' /><span>'+nombre+'</span></a></div>';
    ...
    success: function(response){
        ...
        if(response!=null && response!='' && response!='[]'){ 
            $.each(response,function(key,value){ 
                ...
                document.getElementById('mis-recetas').innerHTML  += '<li><a href="#info" data-transition="fade" onclick="infoReceta('+id+')">'+nombre+'</a></li>';
            });
        }              
    },
          beforeSend: function(){ 
